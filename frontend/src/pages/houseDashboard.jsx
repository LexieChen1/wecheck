  ...
  return (
    <div className="p-6">
      ...
      <p className="text-gray-600 mt-2">
        Invite Code: <span className="font-mono">{house.invite_code}</span>
      </p>
      <p className="text-gray-600">
        Lease: {house.start_date
          ? new Date(house.start_date).toLocaleDateString("en-US", {
              month: "short",
              day: "numeric",
              year: "numeric",
            })
        ...
        {" "}→{" "}
        {house.end_date
          ? new Date(house.end_date).toLocaleDateString("en-US", {
              month: "short",
              day: "numeric",
              year: "numeric",
            })
